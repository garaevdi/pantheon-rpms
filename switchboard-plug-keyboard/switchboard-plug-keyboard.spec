...
%global srcname settings-keyboard
...
%description
The Keyboard plug is a section in the Switchboard (System Settings)
that allows the user to manage keyboard settings and imput methods.
