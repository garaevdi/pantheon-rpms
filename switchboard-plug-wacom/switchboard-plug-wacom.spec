...
%description
The Wacom plug is a section in the Switchboard (System Settings)
that allows the user to manage settings of drawing tablets and
Wacom devices.
